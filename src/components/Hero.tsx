        ...
        <div className="hero__grid">
          <div>
            <h1 className="display display--hero hero__headline">
              write <em className="italic-accent">brilliant</em> reports while
              you sleep.
            </h1>
            <p className="hero__sub">
              throw anything at it — a pdf, a github link, or just a topic — and
              reformant drafts the whole paper. structure, citations, charts,
              uni formatting. all in.
            </p>
            ...
            <div className="doc-stack">
              ...
              <div className="doc doc--front">
                ...
                <div className="doc__chart">
                  <div className="doc__chart-title">
                    Figure 2 · Energy output (kWh)
                  </div>
                ...
                <div className="doc__citation">
                  [1] Smith, J. (2024). Nature Energy, 9(4).
                </div>
              </div>
